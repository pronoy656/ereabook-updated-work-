  ...
  return (
    <div className="bg-white dark:bg-[#1e293b] p-6 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm flex flex-col h-full transition-colors">
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-base font-bold text-slate-800 dark:text-white">User Growth</h3>
      ...
      <div className="flex-1 w-full min-h-[200px] relative">
        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Bar dataKey="users" name="Customers" fill="#8b5cf6" radius={[4, 4, 0, 0]} />
            <Bar dataKey="consultants" name="Consultants" fill="#10b981" radius={[4, 4, 0, 0]} />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
